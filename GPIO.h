...
/**Constant that represent the port and bit from each switch*/
#define SW2_PORT (0x02)
#define SW2_BIT	 (0x06)
#define SW3_PORT (0U)
#define SW3_BIT  (0x04)
#define OFF_VAL	 (0x0U)
...
/*! This data type is used to configure pines from switches as pull up*/
typedef enum
{
	SW_2,
	SW_3
}gpio_as_switch;
/*! This struct contains flags of GPIO to be used by the programmer*/
typedef struct
{
	uint8_t GPIOA_flag_status:1;
	uint8_t GPIOB_flag_status:1;
	uint8_t GPIOC_flag_status:1;
	uint8_t GPIOD_flag_status:1;
	uint8_t GPIOE_flag_status:1;
...
/********************************************************************************************/
/*!
 	 \brief	 This function clears all interrupts that were detected by the GPIO.
...
/********************************************************************************************/
/*!
 	 \brief	 This function configures all values to use GPIOA_bit4 as sw3 and GPIOC_bit6 as sw2.
 	 \param[in]  switch to be configured.
 	 \return 1 if the switch is valid else return 0
 */
...
/********************************************************************************************/
/*!
 	 \brief This initializes a pin on input mode, considering a falling edge interuption.
 	 \param[in] port_name Selected Port.
 	 \param[in] pin Pin to be selected.
 	 \return true
 */
uint8_t init_bit_as_falling_int_input(gpio_port_name_t portName, uint8_t bit);

/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 	 \brief This initializes a pin on output mode, considering a falling edge interuption.
 	 \param[in] port_name Selected Port.
 	 \param[in] pin Pin to be selected.
 	 \return true
 */
uint8_t init_bit_as_output(gpio_port_name_t portName, uint8_t bit);
#endif /* GPIO_H_ */
